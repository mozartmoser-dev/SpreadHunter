                ...
                """INSERT INTO historico_simulacoes
                   (id_chassi, estagio, ativo, preco_ativo, strike_call, strike_put,
                    ...
                    qtd_protecao_call, qtd_protecao_put,
                     ...
                     strikes_bwb_call, strikes_bwb_put,
                     premios_bwb_call, premios_bwb_put,
                     custo_borboleta_call, custo_borboleta_put,
                ...
                [
                    (r["id_chassi"], r["estagio"], r["ativo"],
                     ...
                     r.get("qtd_protecao_call", 0), r.get("qtd_protecao_put", 0),
                      ...
                      r.get("viavel", 0),
                      r.get("strikes_bwb_call"), r.get("strikes_bwb_put"),
                      r.get("premios_bwb_call"), r.get("premios_bwb_put"),
                      r.get("custo_borboleta_call", 0.0), r.get("custo_borboleta_put", 0.0),
                      r.get("lotes_bwb_call", 0), r.get("lotes_bwb_put", 0))
                     for r in registros
                ]
            )
            conn.commit()
