...
class ParametroOperacional:
    ...
    PARAMETROS_DEFAULT = {
        ...
        "premio_risco_colar": {"valor": 1.05, "estrategia": "COLAR", "descricao": "Premio risco Colar (x CDI)"},
        ...
        "premio_risco_colar_calendario": {"valor": 1.2, "estrategia": "COLLAR_CALENDARIO", "descricao": "Premio risco Collar Calendario (x CDI)"},
        "calendario_call_otm_max": {"valor": 0.04, "estrategia": "COLLAR_CALENDARIO", "descricao": "Max OTM da call (% do spot)"},
