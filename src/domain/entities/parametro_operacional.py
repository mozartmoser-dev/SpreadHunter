...
class ParametroOperacional:
    ...
    PARAMETROS_DEFAULT = {
        ...
        "perf_limite_meses": {"valor": 6.0, "estrategia": "PERFORMANCE", "descricao": "Limite de Vencimento (Meses, 0=Sem Limite)"},
        ...
        "limite_protecao_pct": {"valor": 0.0099, "estrategia": "PROTECAO_CAUDA", "descricao": "Fracao maxima do ganho extra consumida pela protecao"},
        ...
        "fator_seguranca_liquidez": {"valor": 0.01, "estrategia": "PROTECAO_CAUDA", "descricao": "Volume diario minimo como multiplo da qtd comprada"},
        "limite_protecao_pct_rendimento": {"valor": 0.0099, "estrategia": "PROTECAO_CAUDA", "descricao": "Fracao do ganho extra para protecao — estagio Rendimento"},
        "limite_protecao_pct_plato": {"valor": 0.0099, "estrategia": "PROTECAO_CAUDA", "descricao": "Fracao do ganho extra para protecao — estagio Plato"},
        "limite_protecao_pct_protecao": {"valor": 0.0099, "estrategia": "PROTECAO_CAUDA", "descricao": "Fracao do ganho extra para protecao — estagio Protecao"},
        ...
        "spread_maximo_pct": {"valor": 0.01, "estrategia": "PROTECAO_CAUDA", "descricao": "Spread bid-ask maximo para considerar cotacao confiavel"},
        ...
        "put_ratio_iv_rank_min": {"valor": 50.0, "estrategia": "PUT_RATIO", "descricao": "IV Rank minimo (0-100) para Put Ratio"},
        "put_ratio_iv_percentile_min": {"valor": 50.0, "estrategia": "PUT_RATIO", "descricao": "IV Percentile minimo (0-100) para Put Ratio"},
        ...
        "put_ratio_peso_alpha": {"valor": 0.7, "estrategia": "PUT_RATIO", "descricao": "Peso da protecao (distancia %% BE) no Score"},
        "put_ratio_peso_beta": {"valor": 0.0, "estrategia": "PUT_RATIO", "descricao": "Peso do lucro maximo no Score"},
        "put_ratio_peso_gamma": {"valor": 0.3, "estrategia": "PUT_RATIO", "descricao": "Peso do credito liquido no Score"},
