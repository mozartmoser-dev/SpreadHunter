...
class ParametroOperacional:
    ...
    PARAMETROS_DEFAULT = {
        ...
        "otimizado_desvios_sigma": {"valor": 2.0, "estrategia": "COLLAR_CALENDARIO", "descricao": "Desvios padrao para o range do otimizado"},
        "otimizado_sigma_rendimento": {"valor": 2.0, "estrategia": "COLLAR_CALENDARIO", "descricao": "Sigma para exigir CDI no estagio Rendimento"},
        "otimizado_ratio_max": {"valor": 1.40, "estrategia": "COLLAR_CALENDARIO", "descricao": "Ratio maximo CALL:ativo permitido"},
        "otimizado_ratio_put_min": {"valor": 0.80, "estrategia": "COLLAR_CALENDARIO", "descricao": "Ratio minimo da PUT permitido"},
        "otimizado_ratio_put_step": {"valor": 0.10, "estrategia": "COLLAR_CALENDARIO", "descricao": "Passo de varredura dos ratios (LOTE/qtd_acao)"},
    }
