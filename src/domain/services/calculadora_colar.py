...
class CalculadoraColar:
    ...
    def calcular(
        ...
        pct_cdi_bruto = pct_ganho_bruto / cdi_periodo if cdi_periodo > 0 else 0
        ...
        viavel = pct_cdi_bruto >= self.premio_risco_colar  # leilão: identifica visualmente, não descarta
